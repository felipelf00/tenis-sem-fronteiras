        ...
        <div className="md:w-7/12 order-first flex flex-col justify-center gap-10 p-5">
          ...
          <div className="md:pl-20">
            <p className="indent-8">
              ...
              esportivo saudável e aprenderem o esporte melhorando a qualidade
              de vida e perspectivas futuras.
            </p>
            <br />
            <p className="indent-8">
              Além de oferecer oportunidades de inclusão e convívio entre
              crianças de diferentes classes sociais, de ocupação do tempo
              ocioso com atividade educativa, e de desenvolvimento esportivo, o
              tênis pode ainda abrir outras portas na vida dessas crianças, seja
            ...
            <p className="indent-8">
              ...
              forma, cada criança que participa do projeto pode, futuramente,
              vir a tornar-se um agente de mudança não apenas da sua vida, mas
              também na sua própria comunidade.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="md:p-20">
          ...
          <p className="indent-8">
            ...
            compostas por até 6 crianças divididas por faixa-etária, das
            seguintes formas:
          </p>
          <br />
          ...
          <p className="indent-8">
            ...
            Stay da Federação Internacional de Tênis (ITF), que possibilita que
            a criança consiga jogar desde a primeira aula. O lema é “saque,
            troque bolas e pontue”. Com materiais adaptados (bolas mais lentas,
            raquetes de cabo curto e leves e quadras menores) a criança consegue
            realizar as atividades desde a primeira aula, sentindo-se capaz e
            motivada a continuar no esporte.
          </p>
        </div>
      </div>
      <div className="flex flex-col md:h-[500px] md:flex-row mb-12">
        ...
        <div className="md:w-7/12 p-5">
          ...
          <p className="md:pl-20 mt-8 indent-8">
            O projeto é coordenado pelo prof. Eduardo Carlos Gonçalves
            Figueiredo, formado em Educação Física pela UFPR, pós-graduado em
            Fisiologia do Exercício pela PUC-PR e em Exercício e Saúde pela
            UFPR, mestre em Educação Física pela UFPR na área de Psicologia do
            Esporte, Técnico Master da CBT, níveis 1 e 2 da ITF e licença A, B e
            C da Confederação Alemã de Tênis, ex-jogador e professor desde 1979.
          </p>
          <br />
          <p className="md:pl-20 indent-8">
            Além disso integram também o projeto os professores ???????????????
            e ???????????????, ambos com formação em Educação Física*.
          </p>
        </div>
      </div>
    </main>
